...
import static org.vshmaliukh.terminal.bookshelf.literature_items.ItemHandler.*;
...
class ItemHandlerTest {
    ...
    void testGetSortedItems() {
        ...
        for (Class<? extends Item> uniqueTypeName : uniqueTypeNames) {
            ...
            for (MenuItemForSorting menuItem : sortingMenuList) {
                List<? extends Item> itemsByType = Utils.getItemsByType(uniqueTypeName, itemList);
    ...
    void testClarificationForSortingItems() {
        ...
        for (Class<? extends Item> uniqueTypeName : uniqueTypeNames) {
            ItemHandler handlerByClass = ItemHandlerProvider.getHandlerByClass(uniqueTypeName);
            List<? extends Item> itemsByType = Utils.getItemsByType(uniqueTypeName, generatedListWithAllTypeItems);
