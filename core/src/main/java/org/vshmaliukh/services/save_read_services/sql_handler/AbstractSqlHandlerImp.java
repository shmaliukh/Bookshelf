...
@NoArgsConstructor
public abstract class AbstractSqlHandlerImp extends SaveReadUserFilesHandler implements AbleToHandleUserTableSql, AbstractSqlHandler {

    @Getter
    @Setter
    protected UserContainer user;

    protected AbstractSqlHandlerImp(String homeDir, String userName) {
