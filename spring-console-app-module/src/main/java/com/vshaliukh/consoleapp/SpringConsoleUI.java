package com.vshaliukh.consoleapp;

import com.vshmaliukh.springwebappmodule.shelf.SpringBootSqlShelfHandler;
...
@Component
@ComponentScan(basePackages = {"com.vshmaliukh.springwebappmodule"})
